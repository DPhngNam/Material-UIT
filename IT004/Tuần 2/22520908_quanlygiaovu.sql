...
UPDATE KHOA SET TRGKHOA = Null WHERE MAKHOA = N'KTMT'
...
ADD CONSTRAINT CK_DAY CHECK
(
    DENNGAY > TUNGAY
)
--13.
ALTER TABLE GIAOVIEN
ADD CONSTRAINT CK_TUOIDILAM CHECK
(
...
--III.
--1.
SELECT HV.MAHV, HV.HO, HV.TEN FROM HOCVIEN AS HV INNER JOIN LOP AS LP 
ON HV.MAHV = LP.TRGLOP
...
FROM KETQUATHI AS KQ 
    ...
    INNER JOIN MONHOC AS MH
        ON MH.MAMH = KQ.MAMH
WHERE KQ.LANTHI = '1' AND KQ.KQUA = 'Khong Dat' AND HV.MALOP = 'K11' AND MH.MAMH = 'CTRR'
--5.
