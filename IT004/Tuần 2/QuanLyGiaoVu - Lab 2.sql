...
INSERT INTO KHOA (MAKHOA, TENKHOA, NGTLAP, TRGKHOA) VALUES (N'KHMT', N'Khoa hoc may tinh', CAST(N'2005-06-07T00:00:00.000' AS DateTime), NULL)
...
--9.
ALTER TABLE LOP 
ADD CONSTRAINT CK_LTR CHECK ( LEFT (TRGLOP,3) = MALOP) 
--10.
